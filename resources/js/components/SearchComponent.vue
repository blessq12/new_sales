...
<template>
    <div class="bg-white container mx-auto">
        <div class="flex-1 mr-4" v-if="type === 'mobile'">
            ...
            <div v-if="searchQuery" class="results">
                <div class="container mx-auto relative">
                    <div
                        class="absolute mt-4 p-4 top-0 right-0 border-b border-gray-200 w-full border border-gray-200 rounded-lg bg-white overflow-y-auto max-h-[500px]"
                    >
                        <p class="p-2">
                        ...
                        <div class="mt-2" v-if="!searchResultsLoading">
                            <ul>
                                <li
                                    v-for="result in searchResults.services"
                                    :key="result.id"
        ...
        <div
            class="mx-auto max-w-7xl px-6 lg:px-8 py-12"
            v-if="type === 'desktop'"
        >
            <div class="relative">
                <div
            ...
            <div
                v-if="searchQuery"
                class="results container mx-auto mt-4 p-4 bg-white border border-gray-200 rounded-lg"
            >
