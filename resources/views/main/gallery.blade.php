...
@section('content')
    <x-hero-banner title="Галерея" description='Фотогалерея компании ООО "Салес"' :breadcrumbs="[['title' => 'Галерея', 'url' => '/gallery']]"></x-hero-banner>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">
                    В нашей галерее представлены фотографии реализованных проектов по очистке и обслуживанию канализационных
                    систем. Мы демонстрируем этапы работ, современное оборудование и результаты нашей деятельности, чтобы вы
                    могли оценить качество и профессионализм нашей компании.
                </p>
            </div>
        </div>
    </div>
                ...
                @foreach ($gallery->images as $image)
                    <div
                        ...
                        <div class="relative" style="padding-top: 100%;">
                            ...
                            <div
                                class="absolute inset-0 bg-transparent bg-opacity-0 transition-opacity duration-300 group-hover:bg-opacity-30 flex items-center justify-center">
                                <a href="/uploads/{{ $image->image_path }}" target="_blank"
