...
@section('title', 'Профессиональные сантехники в Томске и Северске - Ваш надежный помощник!')
@section('description',
    'Ищете качественные услуги сантехников в Томске и Северске? Мы предлагаем профессиональные
    решения для вашего дома. Звоните: 226-224')
@section('keywords', '')
@section('content')
    <!-- Hero секция -->
    <div class="relative isolate overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:py-40 lg:px-8">
            ...
            <h5 class="text-2xl font-bold tracking-tight text-white sm:text-4xl lg:text-2xl max-w-full lg:max-w-[75%]">
                Работаем в Томске, Северске и области!
            </h5>
            ...
            <p class="mt-6 text-lg leading-8 text-gray-300">
                Мы гарантируем высокое качество работы, соблюдение сроков и индивидуальный подход к каждому клиенту.
                Доверьте свои сантехнические задачи профессионалам и наслаждайтесь комфортом и надежностью в вашем
                пространстве.
            </p>
    ...
    <section class="py-24 bg-gray-50">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">
                    В нашем каталоге вы можете найти все необходимые услуги для вашего дома чтобы закрыть все возможные
                    проблемы связанные с водой, водоотведением, отоплением и канализацией.
                </p>
            </div>

            <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                @foreach ($categories as $category)
                    <x-service-category :category="$category" />
                @endforeach
            </div>
        </div>
    </section>
