        ...
        <div class="bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-4xl">
                    <!-- Основное описание -->
                    <div class="prose prose-lg prose-indigo mx-auto mt-6" itemprop="serviceOutput">
                        {!! $service->content !!}
                    </div>

                    <!-- Преимущества -->
                    <div class="mt-16" itemprop="hasOfferCatalog" itemscope itemtype="https://schema.org/OfferCatalog">
                        ...
                        <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 mx-auto">
                            <div class="relative pl-9" itemprop="itemListElement" itemscope
                                itemtype="https://schema.org/Offer">
                                <dt class="inline font-semibold text-gray-900">
                                    <span class="mdi mdi-check-circle absolute left-1 top-1 text-indigo-600 text-xl"></span>
                                    <span itemprop="name">Профессионализм</span>
                                </dt>
                                <dd class="inline" itemprop="description">Наши специалисты имеют многолетний опыт и
                                    постоянно повышают квалификацию.</dd>
                            </div>
                            <div class="relative pl-9" itemprop="itemListElement" itemscope
                                itemtype="https://schema.org/Offer">
                                <dt class="inline font-semibold text-gray-900">
                                    <span class="mdi mdi-clock-check absolute left-1 top-1 text-indigo-600 text-xl"></span>
                                    <span itemprop="name">Оперативность</span>
                                </dt>
                                <dd class="inline" itemprop="description">Выполняем работы точно в срок, учитывая все
                                    пожелания заказчика.</dd>
                            </div>
                            <div class="relative pl-9" itemprop="itemListElement" itemscope
                                itemtype="https://schema.org/Offer">
                                <dt class="inline font-semibold text-gray-900">
                                ...
                                <dd class="inline" itemprop="description">Предоставляем гарантию на все выполненные работы.
                                </dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="mt-16">
                        <div
                            ...
                            <service-form :service-id="{{ $service->id }}"
                                service-name="{{ $service->name }}"></service-form>
